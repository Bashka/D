/**
 * @namespace DJS\widgets\HotKey
 * @author Artur Sh. Mamedbekov
 */
YUI.add('DJS.widgets.HotKey', function(Y){
  /**
   * Данный виджет представляет обработчик нажатия клавиш.
   * После рендеринга виджет не отображается.
   * @param {Object} cnf Параметры класса.
   * @constructor
   * @this {DJS.widgets.HotKey}
   */
  function HotKey(cnf){
  ...
  Y.namespace('DJS.widgets').HotKey = HotKey;
