...
use D\library\patterns\entity\dataType\special\fileSystem\FileSystemName;

require_once substr(__DIR__, 0, strpos(__DIR__, '/D')) . '/D/starter.php';
class FileSystemNameTest extends \PHPUnit_Framework_TestCase{
  /**
   * @covers D\library\patterns\entity\dataType\special\fileSystem\FileSystemName::reestablish
   */
  ...
  /**
   * @covers D\library\patterns\entity\dataType\special\fileSystem\FileSystemName::isReestablish
   */
