<?php
namespace D\library\patterns\entity\cache;
...
abstract class Cache{
   ...
   * @throws \D\library\patterns\entity\exceptions\dataExceptions\NotFoundDataException Выбрасывается в случае невозможности получения данных из ресурса.
  ...
  public function __construct($volume = 50, $resource = null){
    InvalidArgumentException::verify($volume, 'i', [-1]);
    $this->volume = $volume;
