 ...
 */
abstract class Message extends RestorableAdapter implements Interpreter{
  /**
   ...
   * @throws \D\library\patterns\entity\exceptions\semanticExceptions\InvalidArgumentException Выбрасывается в случае получения пустого тела запроса.
   */
  public function setBody($body, $type = 'application/x-www-form-urlencoded', $charset = 'utf-8'){
    InvalidArgumentException::verify($body, 'sif');
    $body = (string) $body;
    $this->body = $body;
